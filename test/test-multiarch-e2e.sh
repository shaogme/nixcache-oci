...
echo ">>> Fetching published cache-index from local registry to verify Schema v6..."
...
# Verify Schema v6 and multi-arch entries
python3 -c "
...
print('>>> Schema v6 and Multi-Arch verification SUCCESS!')
"
